...
const MOCK_SECTORS: SectorBubble[] = [
  ...
  { sectorName: '半導體業',         x:  15.2, y:  0.32, size: 180, stocks: [
    { code: '2330', name: '台積電',   industry: '半導體業',  netBuy:  8230 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '2303', name: '聯電',     industry: '半導體業',  netBuy:  1520 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '2344', name: '華邦電',   industry: '半導體業',  netBuy:   -380 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '2454', name: '聯發科',   industry: '半導體業',  netBuy:  3120 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '3711', name: '日月光投控', industry: '半導體業', netBuy:   890 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '電腦及週邊設備業', x:   8.4, y:  0.18, size: 95, stocks: [
    { code: '2317', name: '鴻海',     industry: '電腦及週邊設備業', netBuy:  3150 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '2382', name: '廣達',     industry: '電腦及週邊設備業', netBuy: -1820 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '2353', name: '宏碁',     industry: '電腦及週邊設備業', netBuy:   420 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '2356', name: '英業達',   industry: '電腦及週邊設備業', netBuy:   -90 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '6515', name: '穎崴',     industry: '電腦及週邊設備業', netBuy:   890 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '光電業',           x:  -3.2, y: -0.12, size: 42, stocks: [
    { code: '2409', name: '友達',     industry: '光電業',    netBuy:  -520 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '3481', name: '群創',     industry: '光電業',    netBuy:  -310 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '3008', name: '大立光',   industry: '光電業',    netBuy:   210 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '通信網路業',       x:   4.1, y:  0.15, size: 38, stocks: [
    { code: '2412', name: '中華電',   industry: '通信網路業', netBuy:   680 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '4904', name: '遠傳',     industry: '通信網路業', netBuy:   290 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '電子零組件業',     x:   6.8, y:  0.22, size: 72, stocks: [
    { code: '2308', name: '台達電',   industry: '電子零組件業', netBuy:  1540 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '2379', name: '瑞昱',     industry: '電子零組件業', netBuy:   760 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '3034', name: '聯詠',     industry: '電子零組件業', netBuy:   430 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '電子通路業',       x:   1.8, y:  0.08, size: 22, stocks: [
    { code: '2392', name: '正崴',     industry: '電子通路業', netBuy:   150 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '2388', name: '威盛',     industry: '電子通路業', netBuy:    80 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '資訊服務業',       x:   2.5, y:  0.11, size: 18, stocks: [
    { code: '3673', name: 'TPK-KY',   industry: '資訊服務業', netBuy:   -90 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '其他電子業',       x:  -1.5, y: -0.05, size: 28, stocks: [
    { code: '2360', name: '致茂',     industry: '其他電子業', netBuy:   120 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  // ── 傳產 ────────────────────────────────────────
  { sectorName: '金融保險',         x:   5.2, y:  0.14, size: 65, stocks: [
    { code: '2882', name: '國泰金',   industry: '金融保險',  netBuy:  1050 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '2886', name: '兆豐金',   industry: '金融保險',  netBuy:   420 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '2884', name: '玉山金',   industry: '金融保險',  netBuy:   310 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '2891', name: '中信金',   industry: '金融保險',  netBuy:   780 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '鋼鐵工業',         x:  -4.8, y: -0.18, size: 35, stocks: [
    { code: '2002', name: '中鋼',     industry: '鋼鐵工業',  netBuy:  -180 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '2006', name: '東和鋼鐵', industry: '鋼鐵工業',  netBuy:   -50 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '航運業',           x:   9.1, y:  0.41, size: 55, stocks: [
    { code: '2603', name: '長榮',     industry: '航運業',    netBuy:  2840 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '2609', name: '陽明',     industry: '航運業',    netBuy:  1650 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '2615', name: '萬海',     industry: '航運業',    netBuy:   920 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '2610', name: '華航',     industry: '航運業',    netBuy:   380 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '汽車工業',         x:   7.3, y:  0.29, size: 32, stocks: [
    { code: '2207', name: '和泰車',   industry: '汽車工業',  netBuy:   520 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '1590', name: '亞德客',   industry: '汽車工業',  netBuy:   680 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '生技醫療',         x:   1.2, y: -0.07, size: 25, stocks: [
    { code: '4576', name: '智擎',     industry: '生技醫療',  netBuy:    80 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '1786', name: '科妍',     industry: '生技醫療',  netBuy:    30 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '建材營造',         x:  -2.1, y:  0.06, size: 20, stocks: [
    { code: '5522', name: '遠雄',     industry: '建材營造',  netBuy:  -120 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '食品工業',         x:   2.8, y:  0.09, size: 18, stocks: [
    { code: '1301', name: '台塑',     industry: '食品工業',  netBuy:   220 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '塑膠工業',         x:  -1.8, y: -0.08, size: 22, stocks: [
    { code: '1303', name: '南亞',     industry: '塑膠工業',  netBuy:   -90 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '1326', name: '台化',     industry: '塑膠工業',  netBuy:   -50 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '化學工業',         x:   0.9, y:  0.03, size: 15, stocks: [
    { code: '1702', name: '南僑',     industry: '化學工業',  netBuy:    40 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '紡織纖維',         x:  -0.7, y: -0.14, size: 12, stocks: [
    { code: '1402', name: '遠東新',   industry: '紡織纖維',  netBuy:   -60 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '電機機械',         x:   3.5, y:  0.17, size: 28, stocks: [
    { code: '1504', name: '東元',     industry: '電機機械',  netBuy:   190 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '1605', name: '華新',     industry: '電機機械',  netBuy:   110 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '電器電纜',         x:  -1.2, y:  0.02, size: 10, stocks: [
    { code: '1603', name: '華電網',   industry: '電器電纜',  netBuy:    20 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '橡膠工業',         x:  -0.5, y: -0.03, size: 8, stocks: [
    { code: '2105', name: '正新',     industry: '橡膠工業',  netBuy:   -30 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '玻璃陶瓷',         x:  -0.3, y:  0.01, size: 6, stocks: [
    { code: '1802', name: '台玻',     industry: '玻璃陶瓷',  netBuy:    10 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '造紙工業',         x:   0.2, y: -0.02, size: 5, stocks: [
    { code: '1902', name: '台紙',     industry: '造紙工業',  netBuy:     5 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '水泥工業',         x:   1.1, y:  0.05, size: 12, stocks: [
    { code: '1101', name: '台泥',     industry: '水泥工業',  netBuy:   130 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
    { code: '1102', name: '亞泥',     industry: '水泥工業',  netBuy:    70 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '觀光餐旅',         x:  -2.8, y:  0.12, size: 14, stocks: [
    { code: '2727', name: '王品',     industry: '觀光餐旅',  netBuy:   -80 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '貿易百貨',         x:   0.6, y:  0.04, size: 10, stocks: [
    { code: '2903', name: '遠百',     industry: '貿易百貨',  netBuy:    25 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
  { sectorName: '油電燃氣',         x:   4.5, y:  0.20, size: 30, stocks: [
    { code: '9945', name: '潤泰新',   industry: '油電燃氣',  netBuy:   340 , foreignNet: 0, trustNet: 0, dealerNet: 0 },
  ]},
