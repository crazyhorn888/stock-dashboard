...
const META = {
  low: {
    ...
    backtest: '647 天回測（可評分 542 日）：3 分出現 9 次，之後 5 個交易日平均 +4.30%，同期大盤 +0.76%，超額 +3.54%。四項從未同時成立。',
  },
  high: {
    title: '高點反轉',
    formula: '4 項條件成立 ≥ 3',
    ...
    backtest: '647 天回測（可評分 542 日）：3 分 21 次、後 5 日 −0.47%（超額 −1.22%）；4 分 3 次、−0.68%（超額 −1.44%）。同期大盤 +0.76%。命中率約五成，命中時通常回檔 5~15%。',
  },
}
